...
export interface Config<ThrowOnError extends boolean = boolean>
	 ...
	 */
	fetch?: (url: string, init?: FetchRequestInit) => ReturnType<typeof fetch>;
	/**
